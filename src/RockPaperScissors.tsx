							...
							{(api) => (
								...
								>
									<Field.Root invalid={!!form.formState.errors.name}>
										<Field.Label className="text-lg mb-2 block font-heading">
											Name
										</Field.Label>
										<Field.Input
									...
									{data.status === 'WIN' && (
										<>
											...
											<div className="grow text-center">
												<h2 className="mt-10 text-2xl font-heading font-bold">
													You won!
												</h2>
			...
			{rockPaperScissors.details.status === 'PLAYING' ? (
				<div className="font-mono flex items-center gap-1">
					...
					<span className="font-bold text-2xl leading-none">
						{rockPaperScissors.details.round}
					</span>
				</div>
			) : (
				<Button
